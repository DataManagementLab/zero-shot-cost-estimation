...
from data_driven_cardinalities.deepdb.rspn.structure.leaves import IdentityNumericLeaf, Categorical
...
def learn_mspn(
    ...
    from data_driven_cardinalities.deepdb.rspn.learning.structure_learning import get_next_operation, learn_structure
