...
class NominalRange:
    ...
    def __init__(self, possible_values, null_value=None, is_not_null_condition=False, scale_factor=1, prob_offset=0):
...
class NumericRange:
    ...
    def __init__(self, ranges, inclusive_intervals=None, null_value=None, is_not_null_condition=False, negated=False,
                 scale_factor=1.0, prob_offset=0):
        self.prob_offset = prob_offset
        self.is_not_null_condition = is_not_null_condition
        self.scale_factor = scale_factor
